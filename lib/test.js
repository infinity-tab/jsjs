...
var PropVar = /** @class */ (function () {
    function PropVar(object, property) {
        this.object = object;
        this.property = property;
    }
    PropVar.prototype.$set = function (value) { this.object[this.property] = value; return true; };
    PropVar.prototype.$get = function () { return this.object[this.property]; };
    PropVar.prototype.$delete = function () { delete this.object[this.property]; };
    return PropVar;
}());
exports.PropVar = PropVar;
var Scope = /** @class */ (function () {
    ...
    Scope.prototype.$find = function (raw_name) {
        ...
        if (this.content.hasOwnProperty(name)) {
            ...
            // root
            if (raw_name in global)
                return new ScopeVar('const', global[raw_name]);
            return null;
        }
    };
...
var eval_1 = __webpack_require__(3);
var options = {
    ecmaVersion: 5,
    sourceType: 'script',
    locations: true,
...
var evaluate_map = {
    ...
    BlockStatement: function (block, scope) {
        var new_scope = scope.invasived ? scope : new scope_1.Scope('block', scope);
    ...
    DebuggerStatement: function (node, scope) { debugger; },
    ...
    LabeledStatement: function (node, scope) { node.type + " \u672A\u5B9E\u73B0"; },
    BreakStatement: function (node, scope) {
        return BREAK_SINGAL;
    },
    ContinueStatement: function (node, scope) {
    ...
    SwitchStatement: function (node, scope) {
        ...
        var new_scope = new scope_1.Scope('switch', scope);
        var matched = false;
    ...
    SwitchCase: function (node, scope) {
    ...
    ThrowStatement: function (node, scope) {
        throw evaluate(node.argument, scope);
    },
    TryStatement: function (node, scope) {
        try {
            ...
            if (node.handler) {
                ...
                var new_scope = new scope_1.Scope('block', scope);
    ...
    CatchClause: function (node, scope) {
        return evaluate(node.body, scope);
    },
    WhileStatement: function (node, scope) {
        while (evaluate(node.test, scope)) {
            var new_scope = new scope_1.Scope('loop', scope);
    ...
    ForStatement: function (node, scope) {
        for (var new_scope = new scope_1.Scope('loop', scope), init_val = node.init ? evaluate(node.init, new_scope) : null; node.test ? evaluate(node.test, new_scope) : true; node.update ? evaluate(node.update, new_scope) : void (0)) {
            var result = evaluate(node.body, new_scope);
            if (result === BREAK_SINGAL) {
                break;
            }
    ...
    ArrayExpression: function (node, scope) {
        return node.elements.map(function (item) { return evaluate(item, scope); });
    },
    ...
    FunctionExpression: function (node, scope) {
        return function () {
            ...
            var new_scope = new scope_1.Scope('function', scope);
            new_scope.invasived = true;
    ...
    Property: function (node, scope, computed) { throw '这里如果被执行了那也是错的...'; },
    // 下面是 es6 / es7 特性, 先不做处理
    ClassExpression: function (node, scope) { throw node.type + " \u672A\u5B9E\u73B0"; },
    RestElement: function (node, scope) { throw node.type + " \u672A\u5B9E\u73B0"; },
    MetaProperty: function (node, scope) { throw node.type + " \u672A\u5B9E\u73B0"; },
    AwaitExpression: function (node, scope) { throw node.type + " \u672A\u5B9E\u73B0"; },
    Super: function (node, scope) { throw node.type + " \u672A\u5B9E\u73B0"; },
    SpreadElement: function (node, scope) { throw node.type + " \u672A\u5B9E\u73B0"; },
    TemplateElement: function (node, scope) { throw node.type + " \u672A\u5B9E\u73B0"; },
    ClassDeclaration: function (node, scope) { throw node.type + " \u672A\u5B9E\u73B0"; },
    TaggedTemplateExpression: function (node, scope) { throw node.type + " \u672A\u5B9E\u73B0"; },
    MethodDefinition: function (node, scope) { throw node.type + " \u672A\u5B9E\u73B0"; },
    AssignmentPattern: function (node, scope) { throw node.type + " \u672A\u5B9E\u73B0"; },
    ObjectPattern: function (node, scope) { throw node.type + " \u672A\u5B9E\u73B0"; },
    ArrayPattern: function (node, scope) { throw node.type + " \u672A\u5B9E\u73B0"; },
    ForOfStatement: function (node, scope) { throw node.type + " \u672A\u5B9E\u73B0"; },
    TemplateLiteral: function (node, scope) { throw node.type + " \u672A\u5B9E\u73B0"; },
    ClassBody: function (node, scope) { throw node.type + " \u672A\u5B9E\u73B0"; },
    ImportDeclaration: function (node, scope) { throw node.type + " \u672A\u5B9E\u73B0"; },
    ExportNamedDeclaration: function (node, scope) { throw node.type + " \u672A\u5B9E\u73B0"; },
    ExportDefaultDeclaration: function (node, scope) { throw node.type + " \u672A\u5B9E\u73B0"; },
    ExportAllDeclaration: function (node, scope) { throw node.type + " \u672A\u5B9E\u73B0"; },
    ImportSpecifier: function (node, scope) { throw node.type + " \u672A\u5B9E\u73B0"; },
    ImportDefaultSpecifier: function (node, scope) { throw node.type + " \u672A\u5B9E\u73B0"; },
    ImportNamespaceSpecifier: function (node, scope) { throw node.type + " \u672A\u5B9E\u73B0"; },
    ExportSpecifier: function (node, scope) { throw node.type + " \u672A\u5B9E\u73B0"; },
    YieldExpression: function (node, scope) { throw node.type + " \u672A\u5B9E\u73B0"; },
    ArrowFunctionExpression: function (node, scope) { throw node.type + " \u672A\u5B9E\u73B0"; },
};
...
var interpreter_code = fs.readFileSync('./lib/interpreter.js', 'utf-8');
var bootstrap = interpreter.run(interpreter_code);
